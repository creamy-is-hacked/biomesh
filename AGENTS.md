...
P5-WP05 are complete, P5A has accepted Phase 5, and P6-WP01 through P6-WP03
are complete; P6-WP04 is the first incomplete item. It may begin only in a
fresh task and does not authorize P6A or later behavior. No post-v1 or new UI
work is authorized.
