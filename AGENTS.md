...
P5-WP05 are complete, P5A has accepted Phase 5, and P6-WP01 through P6-WP04
are complete. P6A is the first incomplete item and may begin only as a fresh
independent audit task from the exact pushed `v0.6.0` implementation tag. P6A
does not authorize P7 or later behavior. No post-v1 or new UI work is
authorized.
